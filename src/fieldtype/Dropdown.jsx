...
const Dropdown = ({ onFormChange, formData, size }) => {
  //   console.log(size, "-----");
  //   console.log(formData);
  const [inputFields, setInputSize] = useState([1]);
  // let inputFields = [1];

  // const listItem = (inputFields) => {
  //   console.log("render");
  ...
  //       <div className="col-4">
  //         <div className="">
  //           <label className="form-label infoLabel mb-1">Option{i + 1}</label>
  //         </div>
  //         <div className="">
  //           {/* <input
  //             type="text"
  ...
  return (
    <div className="row mb-2">
      <div className="col-4">
        <div className="">
          <label className="form-label infoLabel mb-1">Size</label>
        </div>
        <div className="">
          <input
            type="text"
